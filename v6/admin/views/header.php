  ...
  <div class="p-4">
    ...
    <nav>
      <ul class="space-y-2 text-sm">
        <li><a href="perfil.php" class="block hover:bg-orange-50 p-2 rounded">Perfil</a></li>
        ...
        <li><a href="login.php?accion=logout" class="block hover:bg-red-50 p-2 rounded text-brand-red font-semibold">Cerrar sesión</a></li>
      </ul>
    </nav>
  </div>
</aside>
...
<header class="bg-white shadow-md border-b-4 border-brand-purple">
  ...
  <ul class="flex items-center gap-4 text-sm font-medium">
    ...
    <li><a href="perfil.php" class="hover:text-brand-purple">Perfil</a></li>

    <li class="relative">
      <button id="dropdownBtn" class="hover:text-brand-purple focus:outline-none">
        Administrar ▼
      </button>

      <ul id="dropdownMenu"
        class="absolute hidden bg-white shadow-md rounded-md mt-2 w-44 text-sm border z-50">
        <li><a href="estadisticas.php" class="block px-4 py-2 hover:bg-orange-100">Dashboard</a></li>
        <li class="border-t"></li>
        <li><a href="autor.php" class="block px-4 py-2 hover:bg-orange-100">Autores</a></li>
        <li><a href="editorial.php" class="block px-4 py-2 hover:bg-orange-100">Editoriales</a></li>
        <li><a href="edicion.php" class="block px-4 py-2 hover:bg-orange-100">Ediciones</a></li>
        <li class="border-t"></li>
        <li><a href="libro.php" class="block px-4 py-2 hover:bg-orange-100">Libros</a></li>
        <li><a href="categoria.php" class="block px-4 py-2 hover:bg-orange-100">Categorías</a></li>
      </ul>
    </li>
