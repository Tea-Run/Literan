            ...
            <table class="min-w-full text-sm text-left">
                ...
                <thead class="bg-gray-100 text-gray-700 uppercase text-xs tracking-wider">
                    <tr>
                        ...
                        <th class="px-6 py-3">Seudónimo</th>
                ...
                <?php foreach ($autores as $autor): ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-gray-500 italic">
                            <?php echo $autor['seudonimo']; ?>
                        </td>

                        <td class="px-6 py-4 text-center">
                            <div class="flex justify-center gap-3">

                                <a href="autor.php?accion=actualizar&id=<?php echo $autor['id_autor']; ?>"
                                   class="bg-yellow-400 text-white px-3 py-1 rounded-md text-xs font-bold hover:bg-yellow-500 transition-colors">
                                    Editar
                                </a>

                                <a href="autor.php?accion=borrar&id=<?php echo $autor['id_autor']; ?>"
